...
abstract class AddOrEditCommentActionTests : LightPlatformTest() {
    ...
    @Nested
    inner class ActionUpdate : AddOrEditCommentActionTests() {
    ...
    @Nested
    inner class ActionExecution : AddOrEditCommentActionTests() {
