 ...
 */
class ReviewServiceIntegrationTests : LightPlatformTest() {
    ...
    private fun createReviewFile(name: String, vararg comments: Comment) {
        val review = BaseTestHelper.createReviewFile(name, comments.toList())
        runWriteAction {
            ReviewFileWriter.write(review, projectBaseDir)
        }
    }

    private fun getReviewsDir(): com.intellij.openapi.vfs.VirtualFile? {
        return projectBaseDir.findChild(ReviewSettings.getInstance().reviewsDir)
    }

    // ==================== GetAvailableReviewNames ====================

    @Nested
    inner class GetAvailableReviewNames {
    ...
    // ==================== CommentCRUDWithFiles ====================

    @Nested
    inner class CommentCRUDWithFiles {
    ...
    // ==================== CommentRetrievalMethods ====================

    @Nested
    inner class CommentRetrievalMethods {
    ...
    @Nested
    inner class FileRenameHandling {
    ...
    // ==================== RefreshAndNotification ====================

    @Nested
    inner class RefreshAndNotification {
